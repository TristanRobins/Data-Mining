...
The point stands that a very good model can be generated from the tree and random forest method. By combining several trees, a fairly good model is able to be produced. It's possible that using lasso and OLS may yield less error due to less randomness.
